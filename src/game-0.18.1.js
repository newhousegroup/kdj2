...
// 0.18.1 keeps the complete 0.18.0 gameplay path and only increases cannon
// mobility damage from 12-20 percentage points to 16-25 percentage points.
const NativeBlob = globalThis.Blob;
let patchedFinalGame = false;

class KDJPatchedBlob0181 extends NativeBlob {
...
globalThis.Blob = KDJPatchedBlob0181;

try {
  await import("./game-0.12.1.js?v=0.12.1");
} catch (error) {
  document.querySelector("#loadingScreen")?.remove();
  console.error("KDJ2 0.18.1 boot failed", error);
