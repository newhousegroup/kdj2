...
class KDJPatchedBlob011 extends NativeBlob {
  constructor(parts = [], options = {}) {
    ...
    if (
      ...
      nextParts = [patch011(patch010(parts[0]))];
...
globalThis.Blob = KDJPatchedBlob011;

try {
  await import("./game-0.9.3.js?v=0.9.3");
} catch (error) {
  console.error("KDJ2 0.11.0 boot failed", error);
