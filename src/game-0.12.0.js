...
class KDJPatchedBlob0120 extends NativeBlob {
  constructor(parts = [], options = {}) {
    ...
    if (
      ...
      nextParts = [patch0120(patch0113(patch0112(patch0111(patch011(patch010(parts[0]))))))];
...
globalThis.Blob = KDJPatchedBlob0120;

try {
  await import("./game-0.9.3.js?v=0.9.3");
} catch (error) {
  console.error("KDJ2 0.12.0 boot failed", error);
