...
class KDJPatchedBlob0112 extends NativeBlob {
  constructor(parts = [], options = {}) {
    ...
    if (
      ...
      nextParts = [patch0112(patch0111(patch011(patch010(parts[0]))))];
...
globalThis.Blob = KDJPatchedBlob0112;

try {
  await import("./game-0.9.3.js?v=0.9.3");
} catch (error) {
  console.error("KDJ2 0.11.2 boot failed", error);
